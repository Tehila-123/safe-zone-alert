...
import { ArrowLeft, MapPin, Clock, Gauge, ShieldAlert } from "lucide-react";
    ...
    <div className="min-h-screen bg-background p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="min-h-[400px] overflow-hidden">
          <AccidentMap
            accidents={[accident]}
            center={accident.coordinates.split(",").map(c => parseFloat(c.trim())) as [number, number]}
            zoom={15}
            highlightedId={accident.id}
          />
        </Card>
      </div>
    </div>
